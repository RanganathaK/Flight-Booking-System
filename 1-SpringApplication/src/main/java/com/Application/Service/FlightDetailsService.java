...
public class FlightDetailsService {
	...
	public boolean bookSeats(int flightId, int numSeats) {
		...
		if (flight != null) {
			...
			if (availableSeats >= numSeats) {
				Set<Integer> bookedSeatNumbers = generateRandomSeatNumbers(numSeats, availableSeats);
	...
	public Set<Integer> generateRandomSeatNumbers(int numSeats, int totalAvailableSeats) {
